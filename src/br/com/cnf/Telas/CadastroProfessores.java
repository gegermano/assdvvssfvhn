...
public class CadastroProfessores extends javax.swing.JFrame {
    ...
    private static CadastroProfessores cadProfessorres = null;

    /**
     * Creates new form Professores
     */
    private CadastroProfessores() {
        initComponents();
    }

    public static CadastroProfessores novoCadastro() {

        if (cadProfessorres == null) {
            cadProfessorres = new CadastroProfessores();
        }
        return cadProfessorres;
    }

    public CadastroProfessores(TFAPRO professor) {
        initComponents();
        btnCadastrar.setText("Atualizar");
        fieldCodigo.setText(professor.getCodprof());
        fieldCPF.setText(professor.getCpf_prof());
        fieldEmail.setText(professor.getEmail_prof());
        fieldIdade.setText(professor.getIdade_prof());
        fieldNome.setText(professor.getNomeprof());
        fieldTelefone.setText(professor.getTelefone_prof());
        construtor = 2;
    }
    ...
    private void btnVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVoltarActionPerformed
        CadastroProfessores.this.dispose();
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        if (construtor == 2) {
            ...
            professor.setCodprof(fieldCodigo.getText());
            professor.setCpf_prof(fieldCPF.getText());
            professor.setEmail_prof(fieldEmail.getText());
            professor.setIdade_prof(fieldIdade.getText());
            professor.setNomeprof(fieldNome.getText());
            professor.setStatus_prof(status);
            professor.setTelefone_prof(fieldTelefone.getText());

            professorDAO.update(professor);
        } else {
            professorDAO.insert(fieldNome.getText(), fieldCPF.getText(), fieldEmail.getText(),
