...
public class TelaAlunos extends javax.swing.JFrame {
    ...
    private static TelaAlunos instance;

    public static TelaAlunos telaaluno() {
        if (instance != null) {
            return instance;
        }
        return new TelaAlunos();
    }
    ...
    private void initComponents() {
        ...
        jPanelBusca.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Pesquisa de Alunos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
        ...
        rbtnTodosAlunos.setText("Todos os alunos");
        ...
        jPanelLista.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Lista de Alunos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
        ...
        try{
            tabelaAlunos.setModel(alunos.listaPorNome(fieldBusca.getText())
            );
        }catch (Exception ex){
    ...
    private void btnNovoAlunoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoAlunoActionPerformed
        CadastroAlunos cadAlunos = CadastroAlunos.novoCadastro();
        cadAlunos.setResizable(false);
        cadAlunos.setVisible(true);
        cadAlunos.setLocationRelativeTo(null);
    ...
    private void tabelaAlunosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaAlunosMouseClicked
        ...
        if (rbtnAtivos.isSelected()) {
            ...
            aluno = alunos.listaPorCodigo((String) tabelaAlunos.getValueAt(tabelaAlunos.getSelectedRow(), 0));
            if (aluno.getStatus_aluno().equals("AT")) {
                btnAtivar.setEnabled(false);
                btnInativar.setEnabled(true);
            } else {
                btnInativar.setEnabled(false);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        CadastroAlunos cadAlunos = new CadastroAlunos(aluno);

        cadAlunos.setVisible(true);
        cadAlunos.setResizable(false);
        cadAlunos.setLocationRelativeTo(null);
        
        TelaAlunos.this.dispose();
//        if (cadAlunos.attAluno(aluno)){
//            mostraPorNome();
//        }
    }//GEN-LAST:event_btnEditarActionPerformed

    private void btnInativarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInativarActionPerformed
        alunos.updateStatus((String) tabelaAlunos.getValueAt(tabelaAlunos.getSelectedRow(), 0), "IN");
        mostraPorNome();
    }//GEN-LAST:event_btnInativarActionPerformed

    private void btnAtivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtivarActionPerformed
        alunos.updateStatus((String) tabelaAlunos.getValueAt(tabelaAlunos.getSelectedRow(), 0), "AT");
        mostraPorNome();
    }//GEN-LAST:event_btnAtivarActionPerformed

    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        alunos.delete((String) tabelaAlunos.getValueAt(tabelaAlunos.getSelectedRow(), 0));
        mostraPorNome();
    ...
    public void mostraPorNome() {
        String status;
        if (rbtnAtivos.isSelected()) {
            status = "AT";
            try {
                tabelaAlunos.setModel(alunos.listaPorNomeStatus(fieldBusca.getText(), status));
            } catch (Exception ex) {
