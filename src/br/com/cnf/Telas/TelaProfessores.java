...
import br.com.cnf.controle.ProfessorDAO;
...
public class TelaProfessores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnNovoAluno.setText("Novo Professor");
        ...
        jPanelBusca.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Pesquisa de Professores", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
        ...
        rbtnTodosAlunos.setText("Todos os Professores");
        ...
        jPanelLista.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Lista de Professores", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
        ...
        try{
            tabelaAlunos.setModel(professores.listaPorNome(fieldBusca.getText())
            );
        }catch (Exception ex){
    ...
    private void btnNovoAlunoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoAlunoActionPerformed
        CadastroProfessores cadAlunos = CadastroProfessores.novoCadastro();
    ...
    private void tabelaAlunosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaAlunosMouseClicked
        ...
        if (rbtnAtivos.isSelected()) {
            ...
            professor = professores.listaPorCodigo((String) tabelaAlunos.getValueAt(tabelaAlunos.getSelectedRow(), 0));
            if (professor.getStatus_prof().equals("AT")) {
                btnAtivar.setEnabled(false);
                btnInativar.setEnabled(true);
            } else {
                btnInativar.setEnabled(false);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        CadastroProfessores cadAlunos = new CadastroProfessores(professor);
    ...
    private void btnInativarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInativarActionPerformed
        professores.updateStatus((String) tabelaAlunos.getValueAt(tabelaAlunos.getSelectedRow(), 0), "IN");
        mostraPorNome();
    }//GEN-LAST:event_btnInativarActionPerformed

    private void btnAtivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtivarActionPerformed
        professores.updateStatus((String) tabelaAlunos.getValueAt(tabelaAlunos.getSelectedRow(), 0), "AT");
        mostraPorNome();
    }//GEN-LAST:event_btnAtivarActionPerformed

    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        professores.delete((String) tabelaAlunos.getValueAt(tabelaAlunos.getSelectedRow(), 0));
        mostraPorNome();
    ...
    private void mostraPorNome() {
        ...
        if (rbtnAtivos.isSelected()) {
            status = "AT";
            try {
                tabelaAlunos.setModel(professores.listaPorNomeStatus(fieldBusca.getText(), status));
            } catch (Exception ex) {
